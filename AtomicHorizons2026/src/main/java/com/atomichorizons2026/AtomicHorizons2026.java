...
public class AtomicHorizons2026 {
    ...
    public void preInit(FMLPreInitializationEvent event) {
        ...
        // CRITICAL FIX: Register capabilities before any other initialization
        // This prevents NullPointerException when accessing radiation capability
        com.atomichorizons2026.handlers.CapabilityHandler.registerCapabilities();
