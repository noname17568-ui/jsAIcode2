...
public class RegistryHandler {
    ...
    // Lead-Lined Armor (90% защита, замедление)
    ...
    // HEV Suit (85% защита, требует энергию)
    ...
    public static void registerItems(RegistryEvent.Register<Item> event) {
        ...
        event.getRegistry().registerAll(
            ...
            // FLUIDS - SPRINT 2
            new ItemBlock(FluidsRegistry.BLOCK_SULFURIC_ACID).setRegistryName(FluidsRegistry.BLOCK_SULFURIC_ACID.getRegistryName()),
            new ItemBlock(FluidsRegistry.BLOCK_HYDROFLUORIC_ACID).setRegistryName(FluidsRegistry.BLOCK_HYDROFLUORIC_ACID.getRegistryName()),
            new ItemBlock(FluidsRegistry.BLOCK_NITRIC_ACID).setRegistryName(FluidsRegistry.BLOCK_NITRIC_ACID.getRegistryName()),
            new ItemBlock(FluidsRegistry.BLOCK_LIQUID_SODIUM).setRegistryName(FluidsRegistry.BLOCK_LIQUID_SODIUM.getRegistryName()),
            new ItemBlock(FluidsRegistry.BLOCK_LIQUID_LEAD_BISMUTH).setRegistryName(FluidsRegistry.BLOCK_LIQUID_LEAD_BISMUTH.getRegistryName()),
            new ItemBlock(FluidsRegistry.BLOCK_MOLTEN_SALT).setRegistryName(FluidsRegistry.BLOCK_MOLTEN_SALT.getRegistryName()),
            new ItemBlock(FluidsRegistry.BLOCK_URANIUM_HEXAFLUORIDE).setRegistryName(FluidsRegistry.BLOCK_URANIUM_HEXAFLUORIDE.getRegistryName()),
            new ItemBlock(FluidsRegistry.BLOCK_MOLTEN_URANIUM).setRegistryName(FluidsRegistry.BLOCK_MOLTEN_URANIUM.getRegistryName()),
            new ItemBlock(FluidsRegistry.BLOCK_MOLTEN_THORIUM).setRegistryName(FluidsRegistry.BLOCK_MOLTEN_THORIUM.getRegistryName()),
            new ItemBlock(FluidsRegistry.BLOCK_NUCLEAR_WASTE).setRegistryName(FluidsRegistry.BLOCK_NUCLEAR_WASTE.getRegistryName())
        );
        ...
        event.getRegistry().registerAll(
            ...
            SPENT_FUEL_ROD, YELLOWCAKE, URANIUM_HEXAFLUORIDE_ITEM,
            // CONSUMABLES
    ...
    public static void registerModels() {
        ...
        registerItemModel(URANIUM_HEXAFLUORIDE_ITEM);
        
        // ==================== ITEMS (CONSUMABLES) ====================
        registerItemModel(HAZMAT_SPRAY);
        registerItemModel(POTASSIUM_IODIDE);
        registerItemModel(RADAWAY_LEGACY);
        registerItemModel(RADX);
        
        // ==================== SPRINT 2: TOOLS ====================
        registerItemModel(GEIGER_COUNTER);
        registerItemModel(DOSIMETER);
        registerItemModel(RADAWAY_TABLET);
        registerItemModel(RADAWAY_INJECTOR);
        registerItemModel(RADAWAY_ADVANCED);
        
        // ==================== SPRINT 2: ARMOR ====================
        // HAZMAT
        registerItemModel(HAZMAT_HELMET);
        registerItemModel(HAZMAT_CHESTPLATE);
        registerItemModel(HAZMAT_LEGGINGS);
        registerItemModel(HAZMAT_BOOTS);
        // LEAD-LINED
        registerItemModel(LEAD_LINED_HELMET);
        registerItemModel(LEAD_LINED_CHESTPLATE);
        registerItemModel(LEAD_LINED_LEGGINGS);
        registerItemModel(LEAD_LINED_BOOTS);
        // HEV
        registerItemModel(HEV_HELMET);
        registerItemModel(HEV_CHESTPLATE);
        registerItemModel(HEV_LEGGINGS);
        registerItemModel(HEV_BOOTS);
    }
