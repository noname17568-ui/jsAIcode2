...
public class ItemRTG extends ItemBase {
    ...
    public void addInformation(ItemStack stack, World world, List<String> tooltip, ITooltipFlag flag) {
        ...
        tooltip.add(TextFormatting.AQUA + "Energy Output: " + type.getEnergyPerTick() + " RF/t");
        tooltip.add(TextFormatting.GRAY + "Lifespan: " + 
            String.format("%.1f years", type.getLifespan()));
