...
public class ItemRadioactiveIsotope extends ItemBase implements IRadiationSource {
    ...
    public enum IsotopeType {
        ...
        // Бета-излучатели
        COBALT_60("cobalt_60", RadiationType.BETA, 120.0, 5.27),
        CESIUM_137("cesium_137", RadiationType.BETA, 90.0, 30.17),
        IODINE_131("iodine_131", RadiationType.BETA, 110.0, 8.02),
