...
/**
 * Базовый класс для контроллеров мультиблочных структур.
 * Управляет валидацией, формированием и разрушением структуры.
 */
public abstract class AbstractMultiblockController extends TileEntity {
