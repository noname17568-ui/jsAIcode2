...
public class PlayerRadiationCapability implements ICapabilitySerializable<NBTTagCompound> {
    ...
    public static final double THRESHOLD_WITHER = 800;
    public static final double THRESHODE_WITHER = 800; // Deprecated typo, use THRESHOLD_WITHER
    ...
    public RadiationLevel getRadiationLevel() {
        ...
        if (radiationDose >= THRESHOLD_WITHER) return RadiationLevel.WITHER;
