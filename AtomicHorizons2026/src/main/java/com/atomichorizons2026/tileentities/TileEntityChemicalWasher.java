...
/**
 * TileEntity for Chemical Washer.
 * Washes chemical precipitates to remove impurities.
 */
public class TileEntityChemicalWasher extends TileEntity implements ITickable, IChemicalProcessor {
    ...
    private final com.atomichorizons2026.heat.HeatStorage heat = 
        new com.atomichorizons2026.heat.HeatStorage(3000.0, 40.0, 800.0);
    ...
    public void updateProcessing() {
        if (currentRecipe == null) {
            List<ChemicalRecipe> recipes = ChemicalRecipeRegistry.getInstance()
                .getRecipesForMachine("chemical_washer");
        ...
        if (currentRecipe != null && canProcess()) {
            ...
            heat.addHeat(ENERGY_PER_TICK * 0.05, false);
