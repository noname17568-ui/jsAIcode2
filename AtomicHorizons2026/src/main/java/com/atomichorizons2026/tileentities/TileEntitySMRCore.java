...
public class TileEntitySMRCore extends TileEntity implements ITickable {
    ...
    private ItemStackHandler fuelHandler = new ItemStackHandler(1) {
        ...
        public boolean isItemValid(int slot, ItemStack stack) {
            return stack.getItem() == RegistryHandler.FUEL_ROD_HALEU_LEGACY;
        }
    };
    ...
    public void update() {
        ...
        } else if (!fuel.isEmpty() && fuel.getItem() == RegistryHandler.FUEL_ROD_HALEU_LEGACY && energyStorage.getEnergyStored() < MAX_ENERGY) {
